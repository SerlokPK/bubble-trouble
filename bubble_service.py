...
class BubbleService:
    ...
    def init_ball(self, numOfBubbles, collisionTime, bubble_size, amplitude, img):
        ...
        for n in range(number_of_bubbles):
            ...
            bubble = Bubble(self.positionOfBall, self.screen, (self.width, self.height), bubble_size, amplitude,
                            collisionTime, img)
            bubble.speed = 15.8
    ...
    def move_ball(self, projectile1, projectile2, queue):
        for (index, bubble) in enumerate(self.my_bubbles):
            ...
            if isCollision[0] and bubble.collisionTime > 0:
                ...
                self.bubble_and_projectile_collision(isCollision[1], index, projectile1, projectile2, queue)
